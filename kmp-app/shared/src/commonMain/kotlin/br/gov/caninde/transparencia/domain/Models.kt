...
data class WsPayload(
    ...
    val saaeResumo: SaaeResumo? = null,
...
data class ResumoFinanceiroPortal(
    ...
    val percentualArrecadacao: String = "",
    val periodoReferencia: String = "",
    val dadosAtualizadosEm: String = "",
    val consultadoEm: String = "",
    val topFornecedores: List<GtFornecedorResumo> = emptyList(),
    val linksFinanceiros: List<LinkExterno> = emptyList(),
    val gtReceitasPainelUrl: String = "",
    val gtDespesasPainelUrl: String = "",
...
@Serializable
data class SaaeLinhaFinanceira(
