...
function buildLinksTransparenciaCamara() {
  ...
  return [
    ...
    { titulo: 'Licitações', url: `${BASE}/caninde-transparente/licitacoes/`, categoria: 'compras' },
    { titulo: 'Contratos', url: `${BASE}/caninde-transparente/contratos/`, categoria: 'compras' },
